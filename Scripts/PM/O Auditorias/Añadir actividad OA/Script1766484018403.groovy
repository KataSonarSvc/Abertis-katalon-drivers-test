...
CustomKeywords.'com.url_utilidades.urlutilidades.openApplicationUrl'('https://saps4-pre.abertis.com/sap/bc/ui2/flp?saml2=disabled&sap-client=100&sap-language=ES#MaintenanceOrder-change')
...
String fullText = WebUI.getText(findTestObject('Object Repository/Creación Orden Preventivo IT new ID/Page_Creare Manut. Programmata videata iniziale/span_Orden por texto'))
