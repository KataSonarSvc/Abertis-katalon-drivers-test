...
CustomKeywords.'com.url_utilidades.urlutilidades.openApplicationUrl'('https://saps4-pre.abertis.com/sap/bc/ui2/flp?saml2=disabled&sap-client=100&sap-language=IT#MaintenanceOrder-change')
...
String fullText = WebUI.getText(findTestObject('Object Repository/Añadir actividad OP IT new id/Page_Modificare Ordine videata iniziale/span_Salvato text'))
