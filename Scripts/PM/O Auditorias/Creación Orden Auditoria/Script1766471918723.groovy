...
String excel = "DATA PM CREACION ORDEN AUDITORIA ESP.xlsx"
...
WebUI.setText(findTestObject('Object Repository/Creación Orden Preventivo IT new ID/Page_Creare Manut. Programmata  testata centrale/input_S_InputField'), 
    ubic_tecn)
WebUI.setText(findTestObject('Object Repository/Creación Orden Preventivo IT new ID/Page_Creare Manut. Programmata  testata centrale/input_E_InputField'),
	equipo)
