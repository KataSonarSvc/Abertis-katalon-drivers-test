...
WebUI.setText(findTestObject('Object Repository/Compra licitada Corp/Page_Solicitud de pedido/span_Estado de valor Informacin_application_329cf2'), 
    elemento_pep)

WebUI.click(findTestObject('Object Repository/Compra licitada Corp/Page_Solicitud de pedido/span_Ms Datos'))

WebUI.setText(findTestObject('Compras Licitadas/Input_Necesidad'), necesidad)

WebUI.setText(findTestObject('Compras Licitadas/Input_Centro_Beneficio'), centro_beneficio)
