...
WebUI.setText(findTestObject('Compras Licitadas/Input_Tipo_Imp'), tipo_imp)

WebUI.setText(findTestObject('Compras Licitadas/Input_Material_P'), material)

WebUI.setText(findTestObject('Compras Licitadas/Input_Short_Text_P'), texto_breve)

WebUI.setText(findTestObject('Compras Licitadas/Input_Cantidad_Solicitada_P'), cantidad_solicitada)

WebUI.setText(findTestObject('Compras Licitadas/Input_Fecha_Entrega_P'), fecha_entrega)

WebUI.click(findTestObject('Compras Licitadas/Menu_Superior_Mas_Datos'))

WebUI.setText(findTestObject('Compras Licitadas/Textarea_Comentarios_Aprobador_P'), comentarios_aprobador)

WebUI.click(findTestObject('Compras Licitadas/Menu_Superior_Mas_Datos_Check'))

WebUI.click(findTestObject('Compra licitada Corp/Page_Solicitud de pedido/span_Ms Datos'))
