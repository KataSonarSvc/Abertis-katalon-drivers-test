...
try {
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Solicitud de pedido/div_ElementoPEP'), ElementoOTP2)
	
	WebUI.sendKeys(findTestObject('Object Repository/Page_Solicitud de pedido/div_ElementoPEP'), Keys.chord(Keys.ARROW_DOWN))
    ...
    //WebUI.takeScreenshot('Screenshots/SANEF_SP-ASMI-Pep.png', FailureHandling.STOP_ON_FAILURE)
