...
try {
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Entrada de Mercancias/input_BuscadorCompra'), Compra)
	...
	WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Entrada de Mercancias/td_ItemTabla'), 10, FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Entrada de Mercancias/input_Texto de cabecera'), ObjetoCompra)
    ...
    WebUI.click(findTestObject('Object Repository/Page_Entrada de Mercancias/checkbox_POS'))
    ...
    //WebUI.takeScreenshot('Screenshots/SANEF_Recep Materiales.png', FailureHandling.STOP_ON_FAILURE)
