...
WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Home/div_Operational managementOperational purchasing'))

WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Home/div_Minor PurchasingLow Amount'))

WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Minor Purchasing/span_Create'))

WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Solicitud de pedido/span_Supplier_application-zpurchaserequisit_8b86ae'))

WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Solicitud de pedido/span_181720'))
...
WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Solicitud de pedido/span_Cost Center_application-zpurchaserequi_f1d805'))

WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Solicitud de pedido/div_52647'))
...
WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Solicitud de pedido/span_Value State Information_application-zp_4749fd'))

WebUI.click(findTestObject('Object Repository/Compra Menor/Page_Solicitud de pedido/div_E152050003'))
