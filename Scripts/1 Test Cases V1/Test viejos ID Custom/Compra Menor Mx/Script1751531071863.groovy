...
WebUI.setText(findTestObject('Object Repository/Compra Menor Chile/Page_Solicitud de pedido/input_Fecha entrega'), 
    '01072026')
...
WebUI.click(findTestObject('Object Repository/Compra Menor Chile/Page_Solicitud de pedido/span_Necesidad_application-zpurchaserequisi_a36280'))

WebUI.setText(findTestObject('Object Repository/Compra Menor Chile/Page_Solicitud de pedido/input_Centro de coste_AdditionalField4'), 
    '')

WebUI.click(findTestObject('Object Repository/Compra Menor Chile/Page_Solicitud de pedido/span_CG2523000031'))
