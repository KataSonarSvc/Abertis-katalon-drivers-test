...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_Verificar'), 0, FailureHandling.OPTIONAL)
	WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_Verificar'), 0, FailureHandling.OPTIONAL)
    ...
    //WebUI.takeScreenshot('Screenshots/MX_SP-ASMI-Pep.png', FailureHandling.STOP_ON_FAILURE)
