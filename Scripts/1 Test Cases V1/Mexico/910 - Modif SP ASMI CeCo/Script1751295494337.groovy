...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/Page_Acquisto Minore/input_testoBreve'), Keys.chord(Keys.ENTER))
    ...
    //WebUI.takeScreenshot('Screenshots/MX_Modif-SP-ASMI-CeCo.png', FailureHandling.STOP_ON_FAILURE)
