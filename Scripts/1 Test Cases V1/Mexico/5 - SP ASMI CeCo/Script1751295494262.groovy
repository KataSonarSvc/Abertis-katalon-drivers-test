...
try {
    ...
    WebUI.click(findTestObject('Object Repository/Page_Solicitud de pedido/input_PrecioValoracion'))
    ...
    //WebUI.takeScreenshot('Screenshots/MX_SP-ASMI-CeCo.png', FailureHandling.STOP_ON_FAILURE)
