...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Page_Solicitud a Compras/bdi_Crear'), 5, FailureHandling.OPTIONAL)

    WebUI.waitForElementClickable(findTestObject('Page_Solicitud a Compras/bdi_Crear'), 10, FailureHandling.OPTIONAL)
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_Verificar'), 10, FailureHandling.OPTIONAL)

    WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_Verificar'), 10, FailureHandling.OPTIONAL)
    ...
    //WebUI.takeScreenshot('Screenshots/MX_SP-ASPM-Pep.png', FailureHandling.STOP_ON_FAILURE)
