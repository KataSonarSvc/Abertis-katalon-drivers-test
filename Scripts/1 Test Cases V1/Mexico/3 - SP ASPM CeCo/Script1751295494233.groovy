...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Solicitud a Compras/bdi_Crear'), 10, FailureHandling.OPTIONAL)
	WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Solicitud a Compras/bdi_Crear'), 10, FailureHandling.OPTIONAL)
	...
	WebUI.click(findTestObject('Object Repository/Page_Solicitud de pedido/div_Transversal'), FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Solicitud de pedido/input_CentroCoste'), CentroCoste)

    WebUI.sendKeys(findTestObject('Object Repository/Page_Solicitud de pedido/input_CentroCoste'), Keys.chord(Keys.ENTER))
    ...
    //WebUI.takeScreenshot('Screenshots/MX_SP-ASPM-CeCo.png', FailureHandling.STOP_ON_FAILURE)
