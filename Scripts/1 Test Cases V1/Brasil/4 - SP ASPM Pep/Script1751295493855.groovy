...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Requisio de Compras/bdi_Criar'), 20, FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_Verificar'), 30, FailureHandling.STOP_ON_FAILURE)
    ...
    //WebUI.takeScreenshot('Screenshots/Arteris_SP-ASPM-Pep.png', FailureHandling.STOP_ON_FAILURE)
