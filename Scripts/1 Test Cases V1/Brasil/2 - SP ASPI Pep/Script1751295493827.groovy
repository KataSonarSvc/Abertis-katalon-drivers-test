...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Requisio de Compras/bdi_Criar'), 30, FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.click(findTestObject('Page_Solicitud de pedido/checkbox_Desglose'))
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Solicitud de pedido/div_ElementoPEP'), ElementoPEP)

    WebUI.sendKeys(findTestObject('Object Repository/Page_Solicitud de pedido/div_ElementoPEP'), Keys.chord(Keys.ENTER))
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_OK_1'), 20, FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_OK'), 20, FailureHandling.STOP_ON_FAILURE)
