...
try {
    ...
    WebUI.scrollToElement(findTestObject('Object Repository/Page_Requisio de Compras/input_SolicitudDeCompra'), 20, FailureHandling.STOP_ON_FAILURE)

    WebUI.setText(findTestObject('Object Repository/Page_Requisio de Compras/input_SolicitudDeCompra'), Pedido)

    WebUI.sendKeys(findTestObject('Object Repository/Page_Requisio de Compras/input_SolicitudDeCompra'), Keys.chord(Keys.ENTER))

    WebUI.click(findTestObject('Object Repository/Page_Requisio de Compras/bdi_Iniciar'))

    WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Requisio de Compras/link_ItemTabla'), 20, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('Object Repository/Page_Requisio de Compras/link_ItemTabla'))
    ...
    WebUI.waitForElementVisible(findTestObject('Page_Solicitud de pedido/textarea_test'), 50, FailureHandling.STOP_ON_FAILURE)

    WebUI.setText(findTestObject('Object Repository/Page_Solicitud de pedido/textarea_test'), ObjetoCompra)
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Requisio de Compras/input_CalendarioEdit'), FechaEntrega)

    WebUI.sendKeys(findTestObject('Object Repository/Page_Requisio de Compras/input_CalendarioEdit'), Keys.chord(Keys.ENTER))
    ...
    //WebUI.takeScreenshot('Screenshots/Arteris_ModSP-ASPI-CeCo.png', FailureHandling.STOP_ON_FAILURE)
