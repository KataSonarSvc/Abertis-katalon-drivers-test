...
try {
    ...
    //WebUI.click(findTestObject('Object Repository/Page_Solicitud de pedido/btn_ItemCdC'))
    WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_Verificar'), 10, FailureHandling.STOP_ON_FAILURE)
    ...
    //WebUI.takeScreenshot('Screenshots/IT_SP-ASMI-CeCo.png', FailureHandling.STOP_ON_FAILURE)
	WebUI.takeScreenshot()

    WebUI.click(findTestObject('Object Repository/Page_Solicitud de pedido/bdi_OK_1'))

    WebUI.waitForElementClickable(findTestObject('Page_Solicitud de pedido/bdi_Salvar'), 10, FailureHandling.STOP_ON_FAILURE)
